...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width: 600px) {
            ...
            /* تحويل الجدول ليكون عمودي على الجوال */
            .details,
            .details tbody,
            .details tr,
            .details th,
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <table class="details" style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }};">
                    <tr>
                        <th style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }};">
                            {{ __('messages.room_number', ['default' => 'الغرفة المحجوزة']) }}</th>
                        <td style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }};">
                            {{ $booking->room->name ?? $booking->room_id }}</td>
                    </tr>
                    <tr>
                        <th style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }};">
                ...
                @if (!empty($booking->notes))
                    <div class="notes-box"
                        style="border-{{ app()->getLocale() == 'ar' ? 'right' : 'left' }}: 4px solid #d4af37;">
